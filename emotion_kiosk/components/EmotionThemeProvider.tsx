...
> = {
    Happy: {
        gradient: "radial-gradient(ellipse at 50% 40%, rgba(255, 180, 0, 0.22) 0%, rgba(255, 120, 0, 0.1) 40%, transparent 70%)",
        ambientColor: "rgba(255, 199, 0, 0.15)",
        glowOpacity: 0.3,
        pulseSpeed: "2s", // Fast
    },
    Sad: {
    ...
    Stressed: {
        gradient: "radial-gradient(ellipse at 50% 40%, rgba(180, 0, 0, 0.25) 0%, rgba(100, 0, 0, 0.15) 50%, transparent 80%)",
        ambientColor: "rgba(255, 50, 50, 0.2)",
        glowOpacity: 0.4,
        pulseSpeed: "1.2s", // Pulse
    },
    Neutral: {
        gradient: "radial-gradient(ellipse at 50% 40%, rgba(90, 220, 232, 0.15) 0%, rgba(60, 100, 120, 0.08) 40%, transparent 70%)",
        ambientColor: "rgba(90, 220, 220, 0.1)",
        glowOpacity: 0.2,
        pulseSpeed: "8s", // Slow glow
    },
};
